@php
    $title = 'Data Tentor &raquo; Tambah';
@endphp
@extends('layout.template')

@section('content')
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18">Tambah Data Tentor</h3>
    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="position-relative">
                        <input type="text" class="form-control h-58 ps-5" id="nama_tentor"
                            placeholder="Masukkan nama tentor" name="nama_tentor" required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="position-relative">
                        <input type="date" class="form-control h-58 ps-5" id="tanggal_lahir"
                            placeholder="Masukkan harga paket" name="tanggal_lahir" required>
                        <div class="invalid-feedback">
                            Tidak boleh kosong.
                        </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="position-relative">
                        <textarea cols="30" rows="5" class="form-control ps-5 py-3" id="biodata" name="biodata"
                            placeholder="biodata" required></textarea>
                        <div class="invalid-feedback">
                            Tidak boleh kosong
                        </div>
