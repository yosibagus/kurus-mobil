@php
    $title = 'Data Tentor &raquo; Edit ' . $role;
@endphp
@extends('layout.template')

@section('content')
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18">Edit Data {{ $role }}</h3>
    </div>
    ...
    <div class="card bg-white border-0 rounded-10 mb-4">
        <div class="card-body p-4">
            ...
            <form class="row g-3 needs-validation" novalidate method="POST">
                ...
                <div class="col-md-6">
                    ...
                    <div class="position-relative">
                        <input type="text" class="form-control h-58 ps-5" id="nama_lengkap"
                            placeholder="Masukkan nama lengkap" name="nama_lengkap" value="{{ $detail->nama_lengkap }}" required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="position-relative">
                        <input type="number" class="form-control h-58 ps-5" id="no_hp"
                            placeholder="Masukkan No Hp" name="no_hp" value="{{ $detail->no_hp }}" required>
                        <div class="invalid-feedback">
                            Tidak boleh kosong.
                        </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="position-relative">
                        <input type="password" class="form-control h-58 ps-5" id="password" placeholder="Masukkan password"
                            name="password" >
                        <small class="text-primary">Kosongi jika tidak ingin update password</small>
                        <div class="invalid-feedback">
                            Tidak boleh kosong.
                        </div>
                        <i class="ri-price-tag-3-line position-absolute top-0 start-0 fs-20 text-gray-light ps-20"
                ...
                <div class="col-md-12">
                    ...
                    <div class="position-relative">
                        <textarea cols="30" rows="5" class="form-control ps-5 py-3" id="alamat" name="alamat"
                            placeholder="Alamat" required>{{ $detail->alamat }}</textarea>
                        <div class="invalid-feedback">
                            Tidak boleh kosong
                        </div>
                ...
                <div class="col-12">
                    <button class="btn btn-primary fw-semibold text-white py-2 px-3" type="submit">Update Data</button>
