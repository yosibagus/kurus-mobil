@php
    $title = 'Data Paket &raquo; Edit &raquo; ' . $paket->nama_paket;
@endphp
@extends('layout.template')

@section('content')
    <div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
        <h3 class="mb-sm-0 mb-1 fs-18">Edit Data Paket</h3>
    </div>
        ...
        <div class="card-body p-4">
            ...
            <form class="row g-3 needs-validation" novalidate method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                    ...
                    <div class="position-relative">
                        <input type="text" class="form-control h-58 ps-5" id="nama_paket"
                            placeholder="Masukkan nama paket" name="nama_paket" value="{{ $paket->nama_paket }}" required>
                ...
                <div class="col-md-4">
                    ...
                    <div class="position-relative">
                        <select class="form-select form-control h-58 ps-5" id="type_mobil" name="type_mobil" required>
                            ...
                            <option value="Manual" {{ $paket->type_mobil == 'Manual' ? 'selected' : '' }}>Manual</option>
                            <option value="Matic" {{ $paket->type_mobil == 'Matic' ? 'selected' : '' }}>Matic</option>
                        </select>
                        <div class="invalid-feedback">
                            Pilih Salah Satu
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="position-relative">
                        <input type="number" class="form-control h-58 ps-5" id="harga_paket"
                            placeholder="Masukkan harga paket" name="harga_paket" value="{{ $paket->harga_paket }}" required>
                        <div class="invalid-feedback">
                            Tidak boleh kosong.
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="position-relative">
                        <select class="form-select form-control h-58 ps-5" id="status_mobil" name="status_mobil" required>
                            <option selected disabled value="">Pilih...</option>
                            <option value="Ready" {{ $paket->status_mobil == 'Ready' ? 'selected' : '' }}>Ready</option>
                            <option value="Maintenance" {{ $paket->status_mobil == 'Maintenance' ? 'selected' : '' }}>Maintenance</option>
                        </select>
                        <div class="invalid-feedback">
                            Pilih Salah Satu
                        </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="position-relative">
                        <input type="text" class="form-control h-58 ps-5" id="nopol"
                            placeholder="Masukkan Nomor Polisi" name="nopol" value="{{ $paket->nopol }}" required>
                        <div class="invalid-feedback">
                            Tidak boleh kosong.
                        </div>
                        <i class="ri-price-tag-3-line position-absolute top-0 start-0 fs-20 text-gray-light ps-20"
                ...
                <div class="col-md-3">
                    ...
                    <div class="position-relative">
                        <input type="number" class="form-control h-58 ps-5" value="{{ $paket->tahun }}" id="tahun" placeholder="Masukkan tahun"
                            name="tahun" required>
                        <div class="invalid-feedback">
                            Tidak boleh kosong.
                        </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="position-relative">
                        <input type="file" class="form-control h-58 ps-5" id="gambar" placeholder="Masukkan gambar"
                            name="gambar">
                        <div class="invalid-feedback">
                            Tidak boleh kosong.
                        </div>
                        <i class="ri-price-tag-3-line position-absolute top-0 start-0 fs-20 text-gray-light ps-20"
                            style="top: 13px !important;"></i>
                        <small class="text-primary"><a target="blank" href="{{ asset('logo/' . $paket->gambar) }}"><i>Gambar Lama : {{ $paket->gambar }}</i></a></small>
                    </div>
                </div>
                <div class="col-md-3">
                    <label for="logo" class="form-label label">Logo Mobil</label>
                    <div class="position-relative">
                        <input type="file" class="form-control h-58 ps-5" id="logo" placeholder="Masukkan logo"
                            name="logo">
                        <div class="invalid-feedback">
                            Tidak boleh kosong.
                        </div>
                        <i class="ri-price-tag-3-line position-absolute top-0 start-0 fs-20 text-gray-light ps-20"
                            style="top: 13px !important;"></i>
                        <small class="text-primary"><a target="blank" href="{{ asset('logo/' . $paket->logo) }}"><i>Logo Lama : {{ $paket->logo }}</i></a></small>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="position-relative">
                        <textarea cols="30" rows="5" class="form-control ps-5 py-3" id="deskripsi" name="deskripsi"
                            placeholder="Deskripsi" required>{{ $paket->deskripsi }}</textarea>
                        <div class="invalid-feedback">
                ...
                <div class="col-12">
                    <button class="btn btn-primary fw-semibold text-white py-2 px-3" type="submit">Ubah Data</button>
